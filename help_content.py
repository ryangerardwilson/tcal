...
HELP_LINES: tuple[str, ...] = (
    ...
    "  - p = How aligned was this with Jesus-like values: love, truth,",
    "        humility, stewardship?",
    "  - q = What good did it create in the world around you: work,",
    "        family, service, finances?",
    "  - r = Did I honour my body and nervous system while doing it, or",
    "        did I sacrifice them?",
    "",
    "Shortcuts",
    "",
    "q            quit",
